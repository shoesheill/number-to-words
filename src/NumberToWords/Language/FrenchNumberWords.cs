...
/// </summary>
public class FrenchNumberWords : INumberLanguage
{
    ...
    private const string NegativePrefix = "moins";
    ...
    {
        if (text.EndsWith("euro") || text.EndsWith("centime"))
            return text;

        return $"{text} euro";
    }

    public string GetDecimalConnector() => "virgule";
    public string GetFractionalCurrency() => "centime";
