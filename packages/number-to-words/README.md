...
[![npm](https://img.shields.io/npm/v/number-to-words-core?label=npm)](https://www.npmjs.com/package/number-to-words-core)
...
```js
const { convertInteger } = require('number-to-words-core');
...
```js
const { convertFractional } = require('number-to-words-core');
...
```js
const { languages } = require('number-to-words-core');
